...
--technically in real life the IT desk would be in charge of inserting 
  FUNCTION get_hash (p_username  IN  VARCHAR2,
                     p_password  IN  VARCHAR2)
    RETURN VARCHAR2 AS
...
-- adding a new staff
-- technically in real life the IT desk would be in charge of inserting new staff logins by running a sql command:
